...
c1 = [121 180; 136 180; 151 180; 166 180]; % window before MX, 1s = 30units
c2 = [181 240; 181 225; 181 210; 181 195];  % window after MX
...
%     for cj=1:size(c2,1)
        ...
        for s=1:sampleN
            ...
            r = svmdata (rr0rx, t(1), t(2), t(3), t(4));            
            x = [n; r];
...
%     for cj=1:size(c2,1)
        ...
        for s=1:sampleN
            ...
            % rr = 296+205 = 501       
            % ri = 267+36 = 303            
            rin = svmdata (ri0nx, t(1), t(2), t(3), t(4));            
